...
export class AiIngredientExtractionService {
 ...
 getApiAiIngredientExtractionChallenge<TData = void>(params?: GetApiAiIngredientExtractionChallengeParams, options?: HttpClientBodyOptions): Observable<TData>;
 getApiAiIngredientExtractionChallenge<TData = void>(params?: GetApiAiIngredientExtractionChallengeParams, options?: HttpClientEventOptions): Observable<HttpEvent<TData>>;
 getApiAiIngredientExtractionChallenge<TData = void>(params?: GetApiAiIngredientExtractionChallengeParams, options?: HttpClientResponseOptions): Observable<AngularHttpResponse<TData>>;
  getApiAiIngredientExtractionChallenge<TData = void>(
    params?: GetApiAiIngredientExtractionChallengeParams, options?: HttpClientObserveOptions): Observable<TData | HttpEvent<TData> | AngularHttpResponse<TData>> {
    const filteredParams = filterParams({...params, ...options?.params}, new Set<string>([]));

    if (options?.observe === 'events') {
      return this.http.get<TData>(
      `/api/AiIngredientExtraction/challenge`,{
